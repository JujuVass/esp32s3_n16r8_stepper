/**
 * ============================================================================
 * modules/playlist.js - Playlist Management Module
 * ============================================================================
 * Extracted from main.js for better code organization
 * 
 * Dependencies:
 * - PlaylistState (from app.js)
 * - AppState (from app.js)
 * - WS_CMD (from app.js)
 * - DOM (from DOMManager.js)
 * - sendCommand() (from utils.js)
 * - showNotification() (from utils.js)
 * 
 * Contents:
 * - Playlist loading from backend
 * - Playlist modal management
 * - Preset CRUD operations (add, delete, rename, load)
 * - Sequencer integration helpers
 * - Tooltip management
 * ============================================================================
 */
...
function quickAddToSequencer(mode, presetId) {
  ...
  // Validate before sending (validateSequencerLine is in main.js)
...
function loadPresetIntoSequencerModal(mode) {
  ...
  // Trigger validation to update UI state (validateEditForm is in main.js)
...
/**
 * Generate a default preset name based on mode and config
 */
...
/**
 * Generate tooltip HTML for a preset
 */
...
/**
 * Refresh playlist presets display for a specific mode
 */
...
/**
 * Show playlist tooltip for an element
 */
...
/**
 * Filter playlist presets by search term
 */
...
/**
 * Add current mode configuration to playlist
 */
...
/**
 * Load a preset from playlist into the current mode
 */
...
/**
 * Update distance presets based on max available distance
 */
function updateDistancePresets(maxAvailable) {
  // Use cached NodeList for performance (called ~50 times/second via updateUI)
  if (DOM.presetDistanceButtons) {
...
/**
 * Initialize playlist button event listeners
...
function initPlaylistEventListeners() {
  ...
  console.log('✅ Playlist event listeners initialized');
}

// Log module loaded
console.log('✅ modules/playlist.js loaded - Playlist management functions ready');

    ...
    // ========================================================================
    // PLAYLIST FUNCTIONS - Loaded from /js/modules/playlist.js
    // ========================================================================
    // Functions available from playlist.js:
    // - loadPlaylists(callback), updatePlaylistButtonCounters()
    // - openPlaylistModal(mode), closePlaylistModal(), refreshPlaylistPresets(mode)
    // - addToPlaylist(mode), deleteFromPlaylist(mode, id), renamePlaylistPreset(mode, id)
    // - loadPresetInMode(mode, id), getCurrentModeConfig(mode)
    // - generatePresetName(mode, config), generatePresetTooltip(mode, config)
    // - populateSequencerDropdown(mode), quickAddToSequencer(mode, presetId)
    // - loadPresetIntoSequencerModal(mode), previewSequencerPreset(mode, presetId)
    // - showPlaylistTooltip(element), hidePlaylistTooltip(), showSequenceTooltip(element)
    // - filterPlaylistPresets(searchTerm), updateStartPresets(maxDist), updateDistancePresets(maxAvailable)
    // - generateSequenceLineTooltip(line), initPlaylistEventListeners()
    ...
    // ========================================================================
    // PLAYLIST INTEGRATION IN SEQUENCER - Loaded from /js/modules/playlist.js
    // ========================================================================
    // Functions available: populateSequencerDropdown(mode), previewSequencerPreset(mode, presetId),
    // quickAddToSequencer(mode, presetId), loadPresetIntoSequencerModal(mode)
    ...
    // ============================================================================
    // PLAYLIST MANAGEMENT FUNCTIONS - Loaded from /js/modules/playlist.js
    // ============================================================================
    // All playlist functions are now in playlist.js module:
    ...
    // - closePlaylistModalOnOverlayClick, refreshPlaylistPresets
    // - showPlaylistTooltip, hidePlaylistTooltip, showSequenceTooltip
    // - filterPlaylistPresets, addToPlaylist, deleteFromPlaylist
    // - renamePlaylistPreset, loadPresetInMode
    // - updateStartPresets, updateDistancePresets
